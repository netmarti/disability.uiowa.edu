...
<div id="page-wrapper">
  <div id="page" class="<?php print $classes; ?>">
        ...
        <header<?php print $header_attributes; ?>>
          ...
          <?php if ($site_logo || $site_name || $site_slogan): ?>
            ...
            <div<?php print $branding_attributes; ?>>
              ...
              <?php if ($site_logo): ?>
                <div id="logo">
                  <img class="site-logo image-style-none" typeof="foaf:Image" src="<?php print $logo; ?>" alt="<?php print $site_name_unlinked; ?>" />
                </div>
              <?php endif; ?>
    ...
    <?php if ($messages && !$is_front || $page['help']): ?>
      ...
      <div id="footer-wrapper">
        <div class="container clearfix">
          <footer<?php print $footer_attributes; ?>>
            ...
            <a class="youtube" href="<?php print $youtube; ?>">Facebook</a>
            <a class="twitter" href="<?php print $twitter; ?>">Twitter</a>
            <a class="facebook" href="<?php print $facebook; ?>">YouTube</a>
            <?php if (!$logged_in): print theme('links', array('links' => menu_navigation_links('menu-login-menu'))); endif; ?>
          </footer>
        </div>
      </div>
    <?php endif; ?>
